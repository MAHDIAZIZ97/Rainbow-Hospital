...
const Home = () => {
  return (
    ...
    <div className='relative bg-slate-200 flex  sm:gap-10 '>
        ...
        <div>
          <img src={assets.header_img} alt='hero-img' className='hidden md:block max-h-[32rem] px-[5rem]' />
        </div>
    ...
    {/* 2nd part */}
          ...
          <div className='md:col-span-2 col-span-12 border-1 border-gray-400'>
             <ul>
                <li className='p-4 text-center hover:bg-[#11667A] hover:text-white transition-all duration-300 ease-in-out cursor-pointer'> 
                  <GiHospitalCross className=' ml-[7.5rem] md:ml-10 text-3xl text-green-400' />
                   OPD
                </li> 
                <li className='p-4 text-center hover:bg-[#11667A] hover:text-white transition-all duration-300 ease-in-out cursor-pointer'> 
                  <FaBedPulse className=' ml-[7.5rem] md:ml-10 text-3xl text-blue-400' />
                  IPD
                </li>
                <li className='p-4 text-center hover:bg-[#11667A] hover:text-white transition-all duration-300 ease-in-out cursor-pointer'> 
                  <MdOutlineBloodtype className=' ml-[7.5rem] md:ml-10 text-3xl text-cyan-400' />
                  DIAGNSOTIC
                </li>
                <li className='p-4 text-center hover:bg-[#11667A] hover:text-white transition-all duration-300 ease-in-out cursor-pointer'> 
                  <MdSos  className=' ml-[7.5rem] md:ml-10 text-3xl text-red-400' />
                  EMERGENCY 
                </li>
             </ul>
     ...
     {/* 5th part */}
      <div className='px-[13%]'>
          <div className='mt-8'>
            <ul className='text-center'>
              ...
              <li className='text-4xl text-[#11667A] font-semibold'>OUR SPECIALTIES</li>
            </ul>
          </div>
      ...
      <div className='mt-16  px-[13%] ml-3 md:ml-0'>
        ...
        <div className='my-8'>
            <ul className='text-center'>
              <li className='text-2xl text-cyan-400 tracking-widest'>Trusted Care</li>
              <li className='text-4xl text-[#11667A] font-semibold'>OUR DOCTORS</li>
            </ul>
        </div>
        <div className='flex flex-col' >
          <div className='mb-2 ml-[6rem] md:ml-0'>
