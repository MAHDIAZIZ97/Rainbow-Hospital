      ...
      <div>
        ...
        <div>
          ...
          <input 
                ...
                name='experience'
                className='outline-1 outline-blue-600 mx-2 my-2 w-55'
                value = {experience}
        ...
        <div className=''>
          ...
          <select className=' mx-2 w-61 h-6 outline-1 outline-blue-600'
              value={speciality}
        ...
        <div>
          ...
          >
            ...
            <option id='availableDays' name='availableDays' value='Wednesday'>Wednesday</option>
            <option id='availableDays' name='availableDays' value='Thursday'>Thursday</option>
            <option id='availableDays' name='availableDays' value='Friday'>Friday</option>
            <option id='availableDays' name='availableDays' value='Saturday'>Saturday</option>
          </select>
