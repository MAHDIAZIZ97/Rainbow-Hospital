...
const Dashboard = () => {
  ...
  const {staffs,aToken, getAllStaffs,doctors,getAllDoctors} = useContext(adminContext);
    ...
    <div className='p-5'>
       ...
       <div className='flex gap-x-3 gap-y-5 flex-wrap justify-start mt-4 '>
        <NavLink to={'/staff-list'}>
            <div className='border-1 border-blue-900 w-50 p-3 rounded-sm'>
        ...
        <NavLink to={'/doctor-list'}>
          <div className='border-1 border-blue-900 w-60 p-3  rounded-sm'>
        ...
        <NavLink to={'/all-appointments'}>
          <div className='border-1 border-blue-900 w-70 p-3 rounded-sm'>
